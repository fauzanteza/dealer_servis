<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php echo form_open_multipart('dealer/update_motor'); ?>
            ...
            <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <?php if ($motor['foto']): ?>
                            <img src="<?= base_url('uploads/motor/' . $motor['foto']) ?>" class="img-thumbnail">
                        <?php else: ?>
                            <img src="<?= base_url('assets/img/no-image.jpg') ?>" class="img-thumbnail" alt="No Image">
                        <?php endif; ?>
                    </div>
                    <div class="col-sm-9">
